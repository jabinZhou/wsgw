...
<title>Hello world Example</title>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.post("${basePath}/backend/bannerCategory/saveBannerCategory", $("#form1").serialize(), function(info) {
        		if (info.status) {
        			CloseWindow("save");
        		} else {
        			alert(info.info);
        ...
        function SetData(data) {
            if (data.action == "edit") {
                ...
                $.post("${basePath}/backend/bannerCategory/getBannerCategory?id=" + data.id, function(info) {
             	if (info.status) {
