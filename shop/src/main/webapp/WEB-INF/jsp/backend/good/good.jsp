...
<title>Hello world Example</title>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:800px;height:280px;" allowResize="true"
        url="<%=basePath%>/backend/advertise/advertiseList"  idField="id" multiSelect="true" 
    >
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            mini.open({
                url: "${basePath}/backend/advertise/editAdvertise",
        ...
        function remove() {
            ...
            if (rows.length > 0) {
                if (confirm("确定删除选中记录？")) {
                    ...
                    $.post("${basePath}/backend/advertise/delAdvertise?id=" +id, function(info) {
                		if (info.status) {
                			 grid.reload();
                		} else {
                			alert(info.info);
