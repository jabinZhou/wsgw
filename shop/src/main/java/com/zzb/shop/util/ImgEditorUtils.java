...
public class ImgEditorUtils {  
    ...
    public void scale(String srcImageFile, String result, int height, int width, boolean bb) {  
        try {  
            ...
            if("png".equals(extension) || "PNG".equals(extension)){
            	ImageIO.write(toBufferedImage(itemp), "png", new File(result));
            }else{
    ...
    //文件上传,返回文件路径  
    public String uploadFile(MultipartFile file,String dirName,String FILE_PATH, HttpServletRequest request,HttpSession session) throws IOException {  
